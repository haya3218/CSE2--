...
void InitMyChar(void)
{
	...
	gMC.physics_underwater.max_dash = 0x32C;
	gMC.physics_underwater.max_move = 0x5FF;
	gMC.physics_underwater.gravity1 = 0x50;
	gMC.physics_underwater.gravity2 = 0x20;
	gMC.physics_underwater.dash1 = 0x200 / 6;
	gMC.physics_underwater.dash2 = 0x200 / 16;
	gMC.physics_underwater.resist = 0x200 / 10;
	gMC.physics_underwater.jump = 0x500;

	gMC.no_splash_or_air_limit_underwater = 1;
}
...
void ActMyChar_Normal(BOOL bKey)
{
	...
	if (bKey)
	{
		...
		if (lKey & gKeyJump && (gMC.flag & 8 || gMC.flag & 0x10 || gMC.flag & 0x20))
		{
			if (gMC.flag & 0x2000)
			{
