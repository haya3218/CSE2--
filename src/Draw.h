...
extern BOOL gb60fps;
extern BOOL gbAutojump;
extern BOOL gbSmoothScrolling;
extern BOOL gbVsync;
extern BOOL gFourTree;
extern BOOL gbFR;
extern BOOL gbNoDamage;
extern unsigned int gCurrentCion;
extern int gCurrentFPS;
extern int gCurrentTimeScale;
...
typedef enum SurfaceID
{
	...
	SURFACE_ID_CASTS = 37,
	SURFACE_ID_TITLEM = 38,
	SURFACE_ID_OPTIOM = 39,
	SURFACE_ID_MENU_OVERLAY = 41,
	SURFACE_ID_SAVE_BOX = 42,
	SURFACE_ID_BEEG_SAVE_BOX = 43,
	SURFACE_ID_MINUS = 44,
	SURFACE_ID_SAVE_CURSOR = 45,
	SURFACE_ID_MAX = 65535, // 16-bit integer limit ¯\_(ツ)_/¯
} SurfaceID;
...
void SetAltFont(const char *font_name = "font");
void PutText(int x, int y, const char *text, unsigned long color, bool alt_font_enabled = false);
